...
ENTITY chi_nu_pipeline IS

    PORT(

        clk    : IN  STD_LOGIC;                   -- Σήμα �?ολογιο�?
        rst    : IN  STD_LOGIC;                   -- Σήμα επαναφο�?άς
...
END ENTITY chi_nu_pipeline;

ARCHITECTURE Behavioral OF chi_nu_pipeline IS

    SIGNAL t1, t2, t3, t4, t5, t6, t7, t8 : STD_LOGIC_VECTOR(15 DOWNTO 0);
    SIGNAL reg_t1, reg_t2, reg_t3, reg_t4, reg_t5, reg_t6, reg_t7 : STD_LOGIC_VECTOR(15 DOWNTO 0); 
...
BEGIN
    ...
    -- t2 = f(g(t1 �?� k2) �?� 0F65)
    xg_in_temp_2 <= reg_t1 XOR key(47 DOWNTO 32);
    ...
    -- t3 = f(g(t2 �?� k3) �?� 2746)
    xg_in_temp_3 <= reg_t2 XOR key(31 DOWNTO 16);
    ...
    -- t4 = f(g(t3 �?� k4) �?� 0B7C)
    xg_in_temp_4 <= reg_t3 XOR key(15 DOWNTO 0);
    ...
    -- t5 = f(g(t4 �?� k1) �?� CFD5)
    xg_in_temp_5 <= reg_t4 XOR key(63 DOWNTO 48);
    ...
    -- t6 = f(g(t5 �?� k3) �?� 8E45)
    xg_in_temp_6 <= reg_t5 XOR key(31 DOWNTO 16);
    ...
    -- t7 = f(g(t6 �?� k2) �?� 40DA)
    xg_in_temp_7 <= reg_t6 XOR key(47 DOWNTO 32);
    ...
    -- y = f(g(t7 �?� k4) �?� 62F0)
    xg_in_temp_8 <= reg_t7 XOR key(15 DOWNTO 0);
